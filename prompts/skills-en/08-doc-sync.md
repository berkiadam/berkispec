...
> **If the subagent does not run, or does not give a plan:** do not start writing documents "from your head" — STOP, tell the user, and ask whether I should retry the subagent, or put the plan together directly in the main agent according to the aspects of the `doc-sync-planner`.
