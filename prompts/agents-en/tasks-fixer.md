...
5. **Do not write `analyze-report.md` or `analyze-task.md`** — both belong to the orchestrator (you may read `analyze-task.md` if you are given its path). You write `tasks.md` and `tasks-questions.md`.
