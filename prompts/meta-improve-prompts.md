...
| `prompts/skills-hu/03-write-plan.md` | Plan | `spec.md` | `plan.md` (`Task írásra kész`) — kötelező része a `### Teszt-forgatókönyvek` szekció (`TS-NN`, TS1–TS6) és a `### Gépi futtatási tábla` (TP4) |
