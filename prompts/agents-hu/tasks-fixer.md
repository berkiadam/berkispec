...
5. **Ne írd az `analyze-report.md`-t és az `analyze-task.md`-t** — mindkettő az orchestrátoré (az `analyze-task.md`-t olvashatod, ha megkapod az útvonalát). Te a `tasks.md`-t és a `tasks-questions.md`-t írod.
