<!--
  The PROJECT-LANGUAGE blocks of `03b-write-test-plan` (9.4 extraction).
  ...
  `lang/03b-write-test-plan.md#<anchor>`.
...
*"The test-plan quality check passed and every question is closed. Is the plan ready for writing tasks? If you confirm, I will switch it to `<status:ready_for_tasks>` status."*
